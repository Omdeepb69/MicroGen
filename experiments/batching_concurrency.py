...
if __name__ == "__main__":
    ...
    print(f"Executing Static vs Continuous Batching Concurrency Sweep (N={trials} trials, device={target_device})...")
    results = run_batching_concurrency_sweep(n_trials=trials, warmup_trials=warmups, device=target_device)
